...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Solo el beat descargable exige archivo; los servicios/encargos se entregan por chat.
    if (!p.needs_shipping && p.type === 'beat' && !p.file_url) return json(res, 400, { error: 'no_file' });
